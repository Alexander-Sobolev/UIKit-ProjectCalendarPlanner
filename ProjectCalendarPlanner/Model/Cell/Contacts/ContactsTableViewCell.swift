...
class ContactsTableViewCell: UITableViewCell {
    ...
    let nameLabel = UILabel(text: "Alexa Gonsales", font: .avenirNext20())
    let phoneLabel = UILabel(text: "+1 888 888 88 ", font: .avenirNext14())
    let mailLabel = UILabel(text: "AlexaGonsales@gmail.com", font: .avenirNext14())
    ...
    func setConstraints() {
        ...
        let stackView = UIStackView(arrangedSubviews: [phoneImageView, phoneLabel, mailLabel, mailImageView], axis: .horizontal, spacing: 3, distribution: .fillProportionally)
